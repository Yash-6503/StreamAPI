/*
 * Find Second Highest Salary of an Employee using Stream API.
*/
...
public class FindSecondHighestSalary {
    public static void main(String[] args) {
        List<Employee> empList = Arrays.asList(
            ...
            new Employee(103, "Rohit Sharma", 80000.99),
        ...
        Employee emp = empList.stream().sorted((emp1, emp2) -> emp2.salary().compareTo(emp1.salary())).skip(1).findFirst()
        .get();
        System.out.println("\nSecond Highest Salary: \n" + emp);
        
        
        // Second Lowest Salary among all employees
        emp = empList.stream().sorted((emp1, emp2) -> emp1.salary().compareTo(emp2.salary())).skip(1).findFirst().get();
 ...
 * Employee[empId=103, name=Rohit Sharma, salary=80000.99]
